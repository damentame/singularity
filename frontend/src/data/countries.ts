...
export const COUNTRIES: Country[] = [
  ...
  { code: 'IE', name: 'Ireland', dialCode: '+353', flag: '🇮🇪', currency: 'EUR' },
  ...
  { code: 'LU', name: 'Luxembourg', dialCode: '+352', flag: '🇱🇺', currency: 'EUR' },
...
export const getDialCodeByCountry = (code: string): string => {
  const country = getCountryByCode(code);
  return country?.dialCode || '';
};

export const getFlagByCountry = (code: string): string => {
  const country = getCountryByCode(code);
  return country?.flag || '';
};

// Popular countries shown at top of dropdowns
export const POPULAR_COUNTRIES = ['ZA', 'GB', 'US', 'AE', 'AU', 'CH', 'DE', 'FR', 'IT', 'ES', 'PT', 'NL', 'IE', 'NZ', 'CA', 'IN', 'KE', 'NG', 'MU', 'NA', 'BW', 'MZ'];
